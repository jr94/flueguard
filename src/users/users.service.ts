...
export class UsersService {
  ...
  async updateProfile(
    ...
    if (updateUserDto.nombre !== undefined)
      user.first_name = updateUserDto.nombre;
    if (updateUserDto.apellido !== undefined)
      user.last_name = updateUserDto.apellido;
    if (updateUserDto.region !== undefined)
      user.region_id = updateUserDto.region;
    if (updateUserDto.comuna !== undefined)
      user.comuna_id = updateUserDto.comuna;
